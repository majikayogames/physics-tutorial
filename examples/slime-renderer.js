(function () {
    ...
    class SlimeRenderer {
        ...
        createSlime(verts, pixelsPerUnit = 120, baseColor = '#4A90E2') {
    ...
    class SlimeController {
        ...
        spawnSlime() {
            ...
            // Spawn higher up so it doesn't immediately hit the ground
            const centerNode = new PhysObject(0, 2, false); // Raised from 0 to 2
            ...
            for (let i = 0; i < numSides; i++) {
                ...
                const y = 2 + Math.sin(angle) * radius; // Raised to match center
        ...
        render() {
            ...
            if (!this.slimeInstance) {
                this.slimeInstance = this.renderer.createSlime(screenVerts, this.pixelsPerUnit, this.slimeColor);
            } else {
                this.renderer.updateSlime(this.slimeInstance, screenVerts, this.pixelsPerUnit);
            }
        ...
        screenToWorldBounds() {
            return {
                x: window.innerWidth / this.pixelsPerUnit,
                y: window.innerHeight / this.pixelsPerUnit
            };
        }
